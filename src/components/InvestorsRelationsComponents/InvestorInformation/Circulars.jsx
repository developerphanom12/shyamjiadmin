...
import useCirculars from "../../../hooks/invester/investerInfo/useCirculars";
...
const Circulars = () => {
  ...
  const { fetchCirculars, loading, circulars, addCirculars, fetchCircularsById, circularsDetails, setCircularsDetails, updateCirculars, deleteCirculars, } = useCirculars()
  useEffect(() => {
    fetchCirculars()
  }, [])
  ...
  const initialValuesUpdate = {
    title: circularsDetails.title || "",
    file: circularsDetails.file_url || null,
  };
  ...
  const handleSubmitUpdate = (values) => {
    ...
    updateCirculars(circularsDetails.id, formData)
            ...
            <tbody>
              {circulars.map((data, yIdx) => (
                ...
                >
                  ...
                  <td className="p-2 border border-gray-300  hover:underline cursor-pointer">
                  ...
                  <td className="p-2 border border-gray-300">
                    <div className="px-6  flex justify-center">
                      <button className="hover:text-blue-600">
                        <FaEdit onClick={() => {
                          setCircularsDetails({})
                          fetchCircularsById(data.id)
                          setShowEditModel(true)
                        }} />
                      </button>
                      <button className="hover:text-red-600">
                        <MdDelete onClick={() => deleteCirculars(data.id)} />
                      </button>
                    </div>
                  </td>
                ...
                {({ values, setFieldValue }) => (
                  <Form style={{ flexDirection: "column" }} className="flex  gap-5">
                    ...
                    <div>
                      ...
                      {typeof values.file === "string" &&   circularsDetails.file_name ? (
