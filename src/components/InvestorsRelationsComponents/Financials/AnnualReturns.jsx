...
const AnnualReturns = () => {
  ...
  const getAnnualReturns = async () => {
    try {
      const response = await axios.get(
        "https://shyamg-api.desginersandme.com/public/api/user/annual-returns/sections/full"
      );
  ...
  // const initialValues = {
  //   title: "", // Backend me Section ka title (year)
  //   entries: [
  //     { title: "", file: null }, // Each entry
  //   ],
  // };
  ...
  const createSection = async (yearTitle, token) => {
    const response = await axios.post(
      "https://shyamg-api.desginersandme.com/public/api/admin/annual-returns/sections",
      {
        title: yearTitle,
        fields: [
  ...
  const createEntry = async (sectionId, entry, position, token) => {
    ...
    const response = await axios.post(
      `https://shyamg-api.desginersandme.com/public/api/admin/annual-returns/sections/${sectionId}/entries`,
      formData,
      {
        headers: {
          Authorization: `Bearer ${token}`,
      ...
      if (editEntry) {
        ...
        if (entry.file) {
          ...
          response = await axios.post(
            `https://shyamg-api.desginersandme.com/public/api/admin/annual-returns/sections/${sectionId}/entries/${entryId}`,
            formData,
            {
              headers: {
                Authorization: `Bearer ${token}`,
